    ...
    private fun setup(){
        ...
        botonRegistro.setOnClickListener {
            ...
            val notificacion = NotificationCompat.Builder(this,canalID).also {
                ...
                Toast.makeText(this@RegistroActivity, "Bienvenido a la aplicacion de informacion y entrenamientos", Toast.LENGTH_SHORT).show()
            ...
            if (textoEmail.text.isNotEmpty() && textoPass.text.isNotEmpty()){
                FirebaseAuth.getInstance().createUserWithEmailAndPassword(textoEmail.text.toString(),textoPass.text.toString()).addOnCompleteListener {
        ...
        botonInicio.setOnClickListener {
            ...
            if (textoEmail.text.isNotEmpty() && textoPass.text.isNotEmpty()){
                FirebaseAuth.getInstance().signInWithEmailAndPassword(textoEmail.text.toString(), textoPass.text.toString()).addOnCompleteListener {
